...
def tokenize(text):
    """MeCabを使って単語トークンに分割"""
    return mecab.parse(text).strip().split()   #return list(text)
...
decoder, linear_layer, embedding_layer = ar_training(
    decoder, linear_layer, embedding_layer, dataloader, vocab, epochs=30, save_path="model.pth")


# In[6]:


def line_response(prompt):
...
if __name__ == '__main__':
    print("LINEに戻すテキスト: ", line_response("太郎は"))
